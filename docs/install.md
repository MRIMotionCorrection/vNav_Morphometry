Currently we do not provide an automatic installer. Please unpack the .zip file for the distribution, and copy files to the following locations, creating directories if they do not already exist:
